CFLAGS=-g -O2 -I/usr/X11R7/include -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DSTDC_HEADERS=1 -D_FILE_OFFSET_BITS=64 -DHAVE_LIBM=1 -DHAVE_LIBXINE=1 -DHAVE_XINE=1 -DHAVE_LIBX11=1 -DHAVE_X11=1 -DHAVE_LIBXSS=1 -DHAVE_XSCREENSAVER=1
